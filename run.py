...
def index():
    ...
    return render_template('index.html', title='Home | Veggit', recipes=recipes)
...
def view(id):
    ...
    return render_template('view.html', title='View Recipe | Veggit', recipe=recipe)
...
def login():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            return render_template('login.html', title='Login | Veggit', user=None, error="incorrect_login")
        else:
            try:
    ...
    return render_template('login.html', title='Login | Veggit', user=user)
